...
//static int esp32_process_message(char* msg, int msg_len);
...
//
//						/* Clear queue */
//						if( xQueueReceive( xQueueRxLen, ( void * ) &recv_len , ( TickType_t ) 0 ) != pdPASS )
//						{
//							/* Failed to get the message. */
//						}
//
//						/* Send size to queue */
//						if( xQueueSend( xQueueRxLen, ( void * ) &recv_len, ( TickType_t ) 0 ) != pdPASS )
//						{
//						  /* Failed to post the message */
//						}
					}
